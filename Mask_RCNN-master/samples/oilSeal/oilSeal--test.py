...
def detect_and_color_splash(model, image_path=None, video_path=None):
    ...
    visualize.display_instances(
        ...
        ["background","canliao", "liekai", "yiwu"], r['scores'],
...
if __name__ == '__main__':
    ...
    # Load weights
    weights_path = '../../mask_rcnn_oilseal_0029.h5'
    model.load_weights(weights_path, by_name=True)

    # Train or evaluate
    detect_and_color_splash(model, image_path="../../datasets/oilSeal/val/liekai-1.bmp")
    #detect_and_color_splash(model, image_path="D:/03-Cases/01-佳盼(公司名) 油封（产品）/04-打光测试\不良产品图\环光+背光（普通镜头）/沟槽残料/沟槽残料.bmp")
